...
public class ProductController {
	...
	@GetMapping("/")
	public ResponseEntity<List<ProductDto>> findAllProds(@RequestParam(required = false) Long categoryId) {
		if(categoryId!=null)
			return new ResponseEntity<>( productServices.findAll(categoryId), HttpStatus.OK);
	...
	@PostMapping("/")
	public ResponseEntity<ProductDto> insertProd(@Valid @RequestBody ProductDto product) {
	...
	@PutMapping("/{id}")
	public ResponseEntity<ProductDto> updateProds(@PathVariable Long id, @Valid @RequestBody ProductDto product) {
